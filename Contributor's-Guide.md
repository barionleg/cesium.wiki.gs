...
* Please make sure
   ...
   * Were new public functions and properties added?
      ...
      * Update [CHANGES.md](https://github.com/AnalyticalGraphicsInc/cesium/blob/master/CHANGES.md), and the [Features wiki](https://github.com/AnalyticalGraphicsInc/cesium/wiki/Features) if the change is significant.
